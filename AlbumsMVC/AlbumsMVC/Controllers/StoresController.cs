...
namespace AlbumsMVC.Controllers
{
    public class StoresController : Controller
    {
        ...
        public ActionResult AddAlbumToStore(int id)
        {
            AddToStore model = new AddToStore();
        ...
        [HttpPost]
        public ActionResult AddAlbumToStore(AddToStore model)
        {
            var album = db.Albums.Find(model.selectedAlbum);
            var store = db.Stores.Find(model.selectedStore);
