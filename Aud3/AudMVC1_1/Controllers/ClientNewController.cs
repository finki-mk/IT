...
namespace AudMVC1_1.Controllers
{
    public class ClientNewController : Controller
    {
        ...
        // GET: ClientNew/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ClientNew/Create
